...
References --> https://www.educative.io/courses/java-multithreading-for-senior-engineering-interviews/blocking-queue--bounded-buffer--consumer-producer
Credits --> Educative

* */

public class BlockingQueueImplementationUsingSynchronized {
